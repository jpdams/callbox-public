...
// ttps://api.hubspot.com/commenting/v1/commenting/batch


// chrome.webRequest.onBeforeSendHeaders.addListener(onBeforeSendHeadersListener, {
//   urls: ["https://api.hubspot.com/engagements/v2/*"]
...
// chrome.webRequest.onCompleted.addListener(OnCompletedOptions, {
//   urls: ["https://api.hubspot.com/engagements/v2/*"]
// }, ["responseHeaders", "extraHeaders"]);https://api.hubspot.com/engagements/v2/engagements ttps://api.hubspot.com/engagements/v1/engagements/batch?
// https://api.hubspot.com/engagements/v1/engagements/batch?portalId=6481917&clienttimeout=10000&hs_static_app=crm-records-ui&hs_static_app_version=1.17671&engagementId=

chrome.webRequest.onBeforeRequest.addListener(onBeforeRequestListener, {
  urls: ["https://api.hubspot.com/commenting/v1/commenting/batch/*"]
}, ["blocking", "requestBody"]);

chrome.webRequest.onBeforeRequest.addListener(onBeforeRequestListener, {
  urls: ["https://api.hubspot.com/engagements/v2/engagements/*"]
}, ["blocking", "requestBody"]);

// https://api.hubspot.com/engagements/v1/engagements/batch?portalId=6481917&clienttimeout=10000&hs_static_app=crm-records-ui&hs_static_app_version=1.17671&engagementId=
chrome.webRequest.onBeforeRequest.addListener(onBeforeRequestListener, {
  urls: ["https://api.hubspot.com/engagements-emails/v1/email/send?*"]
}, ["blocking", "requestBody", "extraHeaders"]);

chrome.webRequest.onBeforeRequest.addListener(onBeforeRequestListener, {
  urls: ["https://api.hubspot.com/tasks/v1/tasks/*"]
}, ["blocking", "requestBody", "extraHeaders"]);

chrome.webRequest.onBeforeRequest.addListener(onBeforeRequestListener, {
  urls: ["https://api.hubspot.com/associations-writes/*"]
}, ["blocking", "requestBody", "extraHeaders"]);

chrome.webRequest.onBeforeRequest.addListener(onEngagementsBatch, {
  urls: ["https://api.hubspot.com/engagements/v1/engagements/batch?*"]
}, ["blocking", "requestBody", "extraHeaders"]);

// https://api.hubspot.com/engagements/v1/engagements/batch?portalId=6481917&clienttimeout=10000&hs_static_app=crm-records-ui&hs_static_app_version=1.17671&engagementId=17454665483

// chrome.webRequest.onBeforeRequest.addListener(onCreateDeal, {
//   urls: ["https://api.hubspot.com/inbounddb-objects/v1/create-and-bulk-associate?portalId=6481917&clienttimeout=14000&hs_static_app=object-embed&hs_static_app_version=*"]
// }, ["extraHeaders", "requese.webRequest.onResponseStarted.addListener(onCreateDeal, {
//   urls: ["https://api.hubspot.com/inbounddb-objects/v1/create-and-bulk-associate?portalId=6481917&clienttimeout=14000&hs_static_app=object-embed&hs_static_app_version=*"]
...
chrome.webRequest.onBeforeRequest.addListener(onUpdateDeal, {
  urls: ["https://api.hubspot.com/graphql/crm?portalId=*"]
}, ["extraHeaders", "extraHeaders", "requestBody"]);


chrome.webRequest.onBeforeRequest.addListener(onUpdateDealProperties, {
  urls: ["https://api.hubspot.com/deals/v1/deal/*"]
}, ["extraHeaders", "extraHeaders", "requestBody"]);

chrome.webRequest.onBeforeRequest.addListener(onAddDealAssociate, {
  urls: ["https://api.hubspot.com/associations-writes/v1/associations?portalId=*"]
}, ["extraHeaders", "extraHeaders", "requestBody"]);

chrome.webRequest.onBeforeRequest.addListener(onLoadHubspot, {
  urls: ["https://api.hubspot.com/engagements/v1/engagements/batch?portalId=*"]
}, ["extraHeaders", "extraHeaders", "requestBody"]);

chrome.webRequest.onBeforeRequest.addListener(onDeleteFromHubspot, {
  urls: ["https://api.hubspot.com/engagements/v1/engagements/*"]
}, ["extraHeaders", "extraHeaders", "requestBody"]);

chrome.webRequest.onBeforeRequest.addListener(onDeleteFromHubspotDeal, {
  urls: ["https://api.hubspot.com/inbounddb-objects/v1/crm-objects/DEAL/*"]
}, ["extraHeaders", "extraHeaders", "requestBody"]);

// https://api.hubspot.com/inbounddb-objects/v1/crm-objects/DEAL/
// chrome.webRequest.onCompleted.addListener(onAddDealAssociate, { 
//   urls: ["https://api.hubspot.com/associations-writes/v1/associations?portalId=6481917&clienttimeout=14000&hs_static_app=object-embed&hs_static_app_version=*"]
